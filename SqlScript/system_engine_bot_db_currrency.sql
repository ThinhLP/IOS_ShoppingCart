...
--
-- Table structure for table `currrency`
--
...
CREATE TABLE `currrency` (
  ...
  `currency_unit` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `currrency`
--

LOCK TABLES `currrency` WRITE;
/*!40000 ALTER TABLE `currrency` DISABLE KEYS */;
INSERT INTO `currrency` VALUES (1,'VND'),(2,'USD'),(3,'AUD'),(4,'SGD');
